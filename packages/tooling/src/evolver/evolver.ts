import type { AIRequest } from '../ai/ai-client'
import { suggestImprovements } from '../ai/ai-client'
import type { AnalysisResult, EngineContext, PerfHints, SecurityReport } from '../types'
